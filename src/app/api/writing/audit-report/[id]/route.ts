// grantiq/src/app/api/writing/audit-report/[id]/route.ts
...
export async function GET(
  ...
  const { data: draft, error } = await supabase
    .from("grant_drafts")
    .select("id, tier, status, sections, rewritten_sections, coherence_report, audit_report, review_simulation, compliance_report")
    .eq("id", id)
    .single();
